...
import { X, ShieldCheck, FileText, RotateCcw, Globe, MapPin } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
      <div className="bg-white rounded-xl max-w-2xl w-full p-6 sm:p-8 shadow-xl border border-gray-200 max-h-[85vh] flex flex-col space-y-6">
        ...
        <div className="overflow-y-auto text-sm text-gray-600 space-y-4 pr-2 font-light leading-relaxed">
          ...
          {/* Office Address Footer line inside modal */}
          <div className="pt-4 border-t border-gray-100 flex items-start gap-2 text-xs text-gray-500">
            <MapPin className="w-4 h-4 text-[#7A1B28] shrink-0 mt-0.5" />
            <div>
              <p className="font-semibold text-gray-700">Vocal Vantage Office Address:</p>
              <p>VV-Office, Gate 1, University Road, Sargodha, Punjab, Pakistan</p>
            </div>
          </div>
        </div>
